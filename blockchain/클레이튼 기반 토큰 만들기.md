...
- 환경설정 : 
  - kaikas 지갑
  - klaystaion : 지갑 연결, 스테이킹 등등 가능
  - ide.klaytn.com : 프로그래밍 툴
  - baobab.scope.klaytn.com : 실제, 테스토용 토큰 이용현황 모니터링툴
  - baobab.wallet.klaytn.com/create : Klaytn 지갑 및 패스워드 만들기 private key, wallet key 생성
...
- ide 에 새로운 문서 작성 : MyERC20.sol

- ide 에 복사하고 컴파일해주기 (0.5.6버전 이상)
...
- baobab.wallet.klaytn.com/create 에서 Klaytn 지갑 만들고 사용
  - private key, Klaytn Wallet key 저장해놓기



- 다시 ide 에서 `run` 에서

  - Address 에 Klaytn 주소 넣기

  - 타입을 `MyERC20` 으로 선택

  - 코인 정보 기입해주기

  - ![image](https://user-images.githubusercontent.com/58541635/137436230-f140f6cf-8b1b-4dca-ac83-e3ad1a30fcb4.png)

  - 아래 각 정보 있는데 `balance of`에 Klaytn 지갑의 주소 입력 후 `call`

    ![image](https://user-images.githubusercontent.com/58541635/137436325-2640d5de-6cbb-4988-bd91-ce9f1eb8ce31.png)

  - 후에 Kalytnscope 접속해서 `Token` 에서 해당 토큰의 `contract` copy

    ![image](https://user-images.githubusercontent.com/58541635/137437074-90b0e063-ebdc-42ef-9dc8-000ae07faaf5.png)

  - Kalytn 지갑에서 balance 추가

    ![image](https://user-images.githubusercontent.com/58541635/137437161-83f3b9cd-ea18-4898-b44e-ceeb762ef110.png)

  - Kaikas 지갑에서도 토큰추가에 `contract`  주소 입력하면 추가 가능
