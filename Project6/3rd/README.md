...
\3. **시제품 등록**
  ...
  \- **12월 6일 이전까지** **서경은, 오세호, 김영기 각 1건씩 완료 요청**

   -> VMS 및 엣지 모듈간 표준 연동 규격 검증 기술 (서경은)

   -> 엣지 AI의 지속적 최적화 기술 (오세호)

   -> 다중 엣지 보안 단말의 연계 협업 기술 (김영기)

  **- 준비 사항**

   **1) "2. [시제품 등록 작성 샘플] 엣지 보안단말 및 엣지 AI 보안지능 패키지 등록 관리 기술.zip" 파일 참고하여 PPT 파일 작성**

\4. **기술문서 작성**

  \- **12월 6일 이전까지** **양창모, 서경은, 오세호, 김영기 각 1건씩 완료 요청**

   -> 엣지 단말을 위한 엣지 AI 제어 기술 개발 보고서 (양창모)

   -> 영상보안시스템과 엣지 모듈간 표준 연동 규격 기술 개발 보고서 (서경은)

   -> 엣지 단말에서 동작하는 엣지 AI의 지속적 최적화 기술 개발 보고서 (오세호)

   -> 다중 엣지 보안 단말의 연계 협업 기술 개발 보고서 (김영기)

 **- 준비 사항**

   **1) "3-1. 기술문서 작성 양식.zip" 파일 양식에 작성**

​     *** 각 문서는 최소 15Page 이상이 되도록 작성 요청**

   **2) "3-2. 기술문서 작성 샘플.zip" 파일은 2차년도 기술문서 파일로, 참고 자료임**
