...
- 5G기반 선제적 위험대응을 위한 예측적 영상보안 핵심기술 개발 (2차년도)
- 웹 앱 기반 Kubernetes 기능 API 서버 개발,  스트리밍 앱 개발, 클러스터 관리 및 모니터링 툴 배포
...
- 필요한 Docker 명령어를 모듈화한 폴더



#### /k8s

- 필요한 Kubernetes 명령어를 모듈화한 폴더



#### /select-cam

- 웹 앱의 디바이스 선택 기능을 위해 배포가 필요한 select-cam 앱
- 배포를 하게되면 디바이스 선택이 가능하다



#### /templates

- app.py 를 실행 시 기본 Index 템플릿
